...
for sample in "case1" "case2" "ctrl1" "ctrl2"
do
...
interleave-reads.py -o trio1-case1.fq trio1-case1-1.fq trio1-case1-2.fq
interleave-reads.py -o trio1-case2.fq trio1-case2-1.fq trio1-case2-2.fq
