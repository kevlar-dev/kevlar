...
extern int __pyx_module_is_main_kevlar__assembly;
...
static PyObject *__pyx_pf_6kevlar_8assembly_fml_asm(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_records) {
  ...
  {
    __pyx_CoroutineObject *gen = __Pyx_Generator_New((__pyx_coroutine_body_t) __pyx_gb_6kevlar_8assembly_2generator, __pyx_codeobj_, (PyObject *) __pyx_cur_scope, __pyx_n_s_fml_asm, __pyx_n_s_fml_asm, __pyx_n_s_kevlar_assembly); if (unlikely(!gen)) __PYX_ERR(0, 31, __pyx_L1_error)
 ...
 */
  ...
  for (;;) {
    ...
    __pyx_t_5 = __Pyx_PyInt_AddObjC(__pyx_t_2, __pyx_int_1, 1, 0, 0); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 35, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
 ...
 */
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_cur_scope->__pyx_v_num_unitigs); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 43, __pyx_L1_error)
 ...
 *     fml_utg_destroy(num_unitigs, unitigs)
 */
    __pyx_t_8 = __Pyx_PyIndex_AsSsize_t(__pyx_cur_scope->__pyx_v_i); if (unlikely((__pyx_t_8 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 44, __pyx_L1_error)
    __pyx_t_3 = __Pyx_PyStr_FromString((__pyx_cur_scope->__pyx_v_unitigs[__pyx_t_8]).seq); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 44, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_r = __pyx_t_3;
    __pyx_t_3 = 0;
 ...
 *     fml_utg_destroy(num_unitigs, unitigs)             # <<<<<<<<<<<<<<
 */
  fml_utg_destroy(__pyx_cur_scope->__pyx_v_num_unitigs, __pyx_cur_scope->__pyx_v_unitigs);
 ...
 *     cdef int numreads = len(records)
 */
  __pyx_tuple__2 = PyTuple_Pack(8, __pyx_n_s_records, __pyx_n_s_num_unitigs, __pyx_n_s_numreads, __pyx_n_s_reads, __pyx_n_s_i, __pyx_n_s_read, __pyx_n_s_opt, __pyx_n_s_unitigs); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__2);
  __Pyx_GIVEREF(__pyx_tuple__2);
  __pyx_codeobj_ = (PyObject*)__Pyx_PyCode_New(1, 0, 8, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__2, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_kevlar_assembly_pyx, __pyx_n_s_fml_asm, 31, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj_)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __Pyx_modinit_type_init_code(void) {
  ...
  if ((CYTHON_USE_TYPE_SLOTS && CYTHON_USE_PYTYPE_LOOKUP) && likely(!__pyx_type_6kevlar_8assembly___pyx_scope_struct__fml_asm.tp_dictoffset && __pyx_type_6kevlar_8assembly___pyx_scope_struct__fml_asm.tp_getattro == PyObject_GenericGetAttr)) {
    __pyx_type_6kevlar_8assembly___pyx_scope_struct__fml_asm.tp_getattro = __Pyx_PyObject_GenericGetAttrNoDict;
  }
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initassembly(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initassembly(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_assembly(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_assembly(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_assembly(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'assembly' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_assembly(void)", 0);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init kevlar.assembly", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
